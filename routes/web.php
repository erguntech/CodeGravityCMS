...
Route::middleware([
    ...
    Route::middleware(['role:Admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        // Update Management
        Route::resource('updates', \App\Http\Controllers\Backend\UpdateNoteController::class)->except(['show']);
    ...
    Route::middleware(['role:Client'])->prefix('client')->name('client.')->group(function () {
        ...
        Route::middleware(['client_module:blog_management'])->group(function () {
            ...
            Route::resource('blog-post-categories', BlogPostCategoryController::class)->except(['show']);
        ...
        Route::middleware(['client_module:reference_management'])->group(function () {
            ...
            Route::resource('references', ReferenceController::class)->except(['show'])->parameters(['references' => 'reference']);
        });
        ...
        Route::middleware(['client_module:brand_management'])->group(function () {
            ...
            Route::resource('brands', BrandController::class)->except(['show'])->parameters(['brands' => 'brand']);
        });
