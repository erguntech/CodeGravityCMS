...
@section('title', __('Referans Ekleme'))
...
<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 py-5">
    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">{{ __('Referans Ekleme') }}</h1>
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="card card-flush mb-5 mb-xl-10">
            ...
            <div class="card-body pt-6">
                <form action="{{ route($routePrefix . 'references.store') }}" method="POST" id="kt_references_create_form" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade {{ $activeTabCode === $lang->code ? 'show active' : '' }}" id="lang_tab_{{ $lang->code }}" role="tabpanel">
                                    <div class="mb-6">
                                        ...
                                        <input type="text" name="title[{{ $lang->code }}]" class="form-control form-control-solid @error('title.'.$lang->code) border-danger @enderror" placeholder="{{ __('Referans Başlığı Giriniz') }}" value="{{ old('title.'.$lang->code) }}" />
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <textarea name="description[{{ $lang->code }}]" class="form-control form-control-solid @error('description.'.$lang->code) border-danger @enderror" placeholder="{{ __('Referans Açıklaması Giriniz') }}" rows="4">{{ old('description.'.$lang->code) }}</textarea>
                        ...
                        <div class="col-md-6 mb-6">
                            <label class="form-label required">{{ __('Referans Manşet Resmi') }}</label>
                    ...
                    <div class="d-flex justify-content-start">
                        <button type="submit" id="kt_references_create_submit" class="btn btn-sm btn-success me-3">
                            <span class="indicator-label">{{ __('Referans Ekle') }}</span>
...
@push('scripts')
<script>
    const form = document.getElementById('kt_references_create_form');
    const submitButton = document.getElementById('kt_references_create_submit');
