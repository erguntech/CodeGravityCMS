...
@section('title', __('Kullanıcı Düzenleme'))
...
<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 py-5">
    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">{{ __('Kullanıcı Düzenleme') }}</h1>
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="card card-flush mb-5 mb-xl-10">
            ...
            <div class="card-body pt-6">
                <form action="{{ route($routePrefix . 'users.update', $user->id) }}" method="POST" id="kt_user_edit_form" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-6">
                            ...
                            <select name="roles[]" class="form-select form-select-solid @error('roles') is-invalid border-danger @enderror" data-control="select2" data-placeholder="{{ __('Rol Seçiniz') }}" data-allow-clear="true" multiple="multiple" {{ !$isEditableType ? 'disabled' : '' }}>
